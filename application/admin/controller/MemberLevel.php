...
class MemberLevel extends AdminBase {
    ...
    public function index(){
        ...
        //查询数据
        $list=model('MemberLevel')->loadList('page',$where);
        //模板传值
    ...
    public function del(Request $request){
        ...
        if(model('MemberLevel')->del($id)){
            return ajaxReturn(200,'推荐商等级删除成功！');
        }else{
            return ajaxReturn(0,'推荐商等级删除失败！');
        }
    }
}
