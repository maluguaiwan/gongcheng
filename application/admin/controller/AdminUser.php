...
//            }
    ...
    public function save(){
        ...
        if($this->request->isPost()) {
            ...
            if(false == $model->allowField(true)->save($post)) {
                ...
                $this->success('添加管理员成功','admin/admin_user/index');
            }
        }else{
    ...
    public function update(){
        ...
        if ($this->request->isPost()) {
            ...
            if (false == $model->allowField(true)->save($post, ['id' => $post['id']])) {
                ...
                $this->success('修改账户信息成功', 'admin/admin_user/index');
            }
        }else{
            $this->error('修改失败:非法提交！');
        }
        ...
        if($this->request->isAjax()) {
            ...
            if($is_delete == 0) {
                if(true == (new AdminUserModel())->where('id',$post['id'])->update(['is_delete'=>1])) {
                    ...
                    $this->success('删除成功','admin/admin_user/index');
                }
            }
            $this->error('删除失败');
        }
    ...
    public function enable(){
        if($this->request->isPost()) {
            ...
            $this->success('更新成功，启用'.$i.'个账户','admin/admin_user/index');
        }
    }
    ...
    public function prohibit(){
        if($this->request->isPost()) {
            ...
            $this->success('更新成功，禁用'.$i.'个账户','admin/admin_user/index');
        }
    }
    ...
    public function delete_all(){
        if($this->request->isPost()) {
            ...
            $this->success('更新成功，删除'.$i.'个账户','admin/admin_user/index');
        }
    }
    ...
    public function reset_password(){
        if($this->request->isPost()) {
            ...
            $this->success('更新成功，重置'.$i.'个账户密码:'.$this->andConfig['default_password'],'admin/admin_user/index');
        }
    }
    ...
    public function edit_roles(){
        ...
        if($this->request->isPost()) {
            ...
            if (false == $model->saveRolesByID($id,$post['roles'])) {
                ...
                $this->success('修改规则信息成功','admin/admin_user/index');
            }
        }else {
            if($id == 0) {
                $this->error('id不能为空');
