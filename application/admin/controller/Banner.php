...
class Banner extends AdminBase {
    ...
    public function index(){
        ...
        //查询数据
        $list=model('Banner')->loadList('page',$where,'*',15,'sort ASC');
        //模板传值
    ...
    public function del(Request $request){
        ...
        $map = array();
        $map['id'] = $id;
        if(model('Banner')->del($id)){
            return ajaxReturn(200,'轮播图删除成功！');
        }else{
            return ajaxReturn(0,'轮播图删除失败！');
        }
    }
}
